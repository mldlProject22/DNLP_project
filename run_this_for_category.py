...
from datasets_category import PersianDataset
...
def configure_dataloaders(train_batch_size = 4 ,eval_batch_size = 4, shuffle = False,sep_token=None, input_format=0):
